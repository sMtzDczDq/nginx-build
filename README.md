...
3. `sudo curl -L https://raw.githubusercontent.com/sMtzDczDq/nginx-build/master/build-nginx.sh -o build_nginx.sh`
...
through a [GitHub issue](https://github.com/sMtzDczDq/nginx-build/issues).
